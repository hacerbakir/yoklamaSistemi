...
class AddFace extends StatefulWidget {
  AddFace({required this.email, required this.nameSurname, required this.no});
  String nameSurname, no, email;
  @override
  AddFaceState createState() => AddFaceState();
}

class AddFaceState extends State<AddFace> {
  File? jsonFile;
  ...
  createData() async {
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('students').doc(widget.no);
  ...
  String compare(List currEmb) {
    if (data.length == 0) return "Yüz Kaydedilmedi";
    double minDist = 999;
    double currDist = 0.0;
    String predRes = "Yeni Öğrenci";
